...
admin = {
    ...
    'markup': [
        ['Сделать рассылку'], ['изменить баланс', 'пополнить баланс', 'заявки на вывод'], ['⛔️ Отмена']
    ]
}
new_ref = {'text': '''😃 Вам начислен {} руб за  приглашенного вами друга 😎'''.format(settings.new_ref_cost)}
rules = {
    'text': '''👮ПРАВИЛА использования бота "Рабочие деньги"
...
⛔️Минимальная стоимость: {} рублей.'''.format(settings.min_post_cost),
    ...
    'error_not_admin': {
        ...
        'markup': [
            [{'text': 'Проверить', 'data': 'check_admin'}, {'text': '❌ Отклонить', 'data': 'cancel_check_admin'}]]
    },
    'error_low_cost': {
        'text': '''🚫 Ошибка!
...
💵 Заработано с ➕: *%money_for_views%*р
💵 Заработано с 👁‍🗨: *%money_for_post%*р
💵 Заработано с 👥: *%money_for_refs%*p
💸 Выплачено всего: *%money_out%*р''',
    'markup': start['markup']
}
...
post_enter_cost = {
    'text': 'Введите стоимость каждого просмотра. Стоимость 1 просмотра не может быть ниже {} рубля. Так же чем выше стоимость 1 просмотра - тем выше пост в очереди просмотров.'.format(
        settings.min_view_cost),
    'markup': [['⛔️ Отмена']],
    'error': {
        'text': 'Ошибка! Введите число',
        'markup': [['⛔️ Отмена']]
